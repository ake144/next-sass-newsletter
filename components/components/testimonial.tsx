    ...
    <section className="theme-light">
      <style>
        ...
        @media (prefers-color-scheme: dark) {
          .theme-light {
            background-color: text-gray-950;
            color: #ffffff;
          }
        }
        `}
      ...
      <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <h2 className="text-center text-4xl font-bold tracking-tight text-white ` dark:*:text-gray-900 sm:text-5xl">
          ...
          <blockquote className="rounded-lg bg-gray-800 p-6 shadow-sm sm:p-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="mt-0.5 text-lg font-medium text-gray-300">Paul Starr</p>
              </div>
            </div>
