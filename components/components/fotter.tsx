          ...
          <div className="mx-auto max-w-sm lg:max-w-none">
            ...
            <div className="mt-6 flex justify-center gap-4 lg:justify-start">
              ...
              >
                ...
                <svg xmlns="http://www.w3.org/2000/svg" className='w-6 h-6'  x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
              ...
              <a  className="text-gray-700 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75"
              href='https://github.com/ake144/'
              target='_blank'
              >
                <span  className='sr-only'>Github</span>
                    <svg xmlns="http://www.w3.org/2000/svg"  className='h-6 w-6'  x="0px" y="0px" width="40" height="15" viewBox="0 0 48 48">
              ...
              <a
                className="text-gray-700 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75"
                href="https://twitter.com/AkeTamirat94397"
                target="_blank"
                rel="noreferrer"
              >
